...
function handleQuestion() {
    ...
    for (let i = 0; i <= quizLength; i++) {
        ...
        `<div id="answerBox">
            ...
            <h6>Correct Answer: ${questions[i].correctAnswer}</h6>
            <p id="placeholder">You answered: ${questions[i].userAnswer}</p>
        </div>`;
        ...
        for (let k = 0; k <= i; k++) {
            ...
            h4s[k].classList.add("questions");
            h6s[k].classList.add("correct-answer");
            ps[k].classList.add("placeholder-yourAnswer");
        }
    }
